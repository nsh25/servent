...
class CorrectionConfig:
    ...
    max_correction_depth: Optional[float] = None
...
class OptimizationConfig:
    ...
    min_trades_constraint: int = 3
    max_trials: int = 30
    top_n_results_to_save: int = 5
    random_seed: int = 7
...
class WalkForwardConfig:
    ...
    walk_forward_mode: str = "rolling_window"
    train_bars: int = 200
    test_bars: int = 100
    step_bars: int = 100
    warmup_bars: int = 50
    retune_each_window: bool = True


@dataclass
class WalkthroughConfig:
    walkthrough_enabled: bool = False
    walkthrough_setup_id: Optional[int] = None
    walkthrough_save_chart: bool = False
    walkthrough_verbose: bool = True
    walkthrough_save_frames: bool = False
